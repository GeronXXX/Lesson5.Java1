public class Java1 {
    public static void main(String[] args) {
        ...
        System.out.println("Вычетание " + (value1 - value2));
        System.out.println("привкдение типа " + value3);
        ...
        System.out.println("Оператор сравдения больше " + c);
        System.out.println("Оператор сравдения равно " + b);
        System.out.println("Оператор сравдения не равно " + d);
